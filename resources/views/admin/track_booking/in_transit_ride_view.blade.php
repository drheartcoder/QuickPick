...
<div id="breadcrumbs">
  <ul class="breadcrumb">
    <li>
      ...
      <a href="{{ url($admin_panel_slug.'/dashboard') }}">Dashboardnn
      </a>
    </li>
    <span class="divider">
                      ...
                      <tbody>
                            ...
                            <tr>
                             ...
                             <tr>
                              ...
                              <td style="width: 30%">
                                @if(isset($arr_data['booking_status']) &&  $arr_data['booking_status'] == 'IN_TRANSIT')
                                  <span class='badge badge-warning' style="width:115px">In Transit</span>
                                @endif
                              </td>
                            </tr> 
        ...
        if(marker!=undefined && marker!=''){
          if (marker.driver_id != undefined) {
              if ((marker.driver_id == obj_available_driver.driver_id)) {
                  ...
                  // var curr_lat = parseFloat(obj_available_driver.current_latitude);
                  // var curr_lng = parseFloat(obj_available_driver.current_longitude);
