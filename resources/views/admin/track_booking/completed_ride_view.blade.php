...
<div class="row">
                    ...
                    <table class="table table-bordered">
                      <tbody>
                            ...
                            @elseif(isset($arr_data['booking_status']) && $arr_data['booking_status'] == 'COMPLETED')
                                ...
                                @if(isset($arr_data['is_individual_vehicle']) && $arr_data['is_individual_vehicle'] == '1')
                                    <tr>
                                      ...
                                      <td style="width: 30%">
                                        {{ isset($arr_data['individual_driver_percentage']) ? number_format($arr_data['individual_driver_percentage'],2) : '0,0' }} <strong>%</strong>
                                      </td>
                            ...
                            <tr>
                              ...
                              {{-- <th style="width: 20%">Invoice Image
                              </th>
                              <td style="width: 30%">
                                 @if(isset($arr_bookings['invoice_image']) && $arr_bookings['invoice_image']!='')
                                    @if(file_exists($load_post_img_base_path.$arr_bookings['invoice_image']))
                                        <a target="_blank" href="{{$load_post_img_public_path.$arr_bookings['invoice_image']}}"><img style="height: 120px" src="{{$load_post_img_public_path.$arr_bookings['invoice_image']}}"></a>
                                    @else
                                      -
                                    @endif
  ...
  <script type="text/javascript">
    ...
    var pickup_lng      = '{{isset($arr_data['pickup_lng']) ? $arr_data['pickup_lng'] :'' }}';
   ...
   function SetActualTraveledMarker() {
            ...
            arr_coordinates.forEach(function(value,index){
                if(value!=undefined){
                  if(index == 0){
                    ...
                    var sourceMarkerImage = new google.maps.MarkerImage(
                                    BASE_URL+'/node_assets/images/pointer.png',
                                    new google.maps.Size(36,36), //size
                                    null, //origin
                                    null, //anchor
