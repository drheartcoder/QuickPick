    ...
    <div class="box ">
      ...
      <div class="box-content">
        <?php
            ...
            $driver_id          = isset($arr_bookings['rider_to_driver_request_details']['driver_id']) ? $arr_bookings['rider_to_driver_request_details']['driver_id'] :0;
            $vehicle_id         = isset($arr_bookings['rider_to_driver_request_details']['vehicle_id']) ? $arr_bookings['rider_to_driver_request_details']['vehicle_id'] :0;

            $rider_first_name   = isset($arr_bookings['rider_to_driver_request_details']['rider_details']['first_name']) ? $arr_bookings['rider_to_driver_request_details']['rider_details']['first_name'] :"";
            $rider_last_name    = isset($arr_bookings['rider_to_driver_request_details']['rider_details']['last_name'])  ? $arr_bookings['rider_to_driver_request_details']['rider_details']['last_name']  :"";

            $rider_name         = $rider_first_name." ".$rider_last_name;

            $driver_first_name  = isset($arr_bookings['rider_to_driver_request_details']['driver_details']['first_name']) ? $arr_bookings['rider_to_driver_request_details']['driver_details']['first_name'] :"";
            $driver_last_name   = isset($arr_bookings['rider_to_driver_request_details']['driver_details']['last_name'])  ? $arr_bookings['rider_to_driver_request_details']['driver_details']['last_name']  :"";

            $driver_name        = $driver_first_name." ".$driver_last_name;

            $pickup_location    = isset($arr_bookings['rider_to_driver_request_details']['source_location']) ? $arr_bookings['rider_to_driver_request_details']['source_location'] :"";

            $dropup_location    = isset($arr_bookings['rider_to_driver_request_details']['destination_location'])    ? $arr_bookings['rider_to_driver_request_details']['destination_location'] :"";

            $vehicle_name       = isset($arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_name']) ? $arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_name'] :"";

            $vehicle_number     = isset($arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_number']) ? $arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_number'] :"";

            $vehicle_model      = isset($arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_model_name']) ? $arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_model_name'] :"";

            $vehicle_type       = isset($arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_type_details']['vehicle_type']) ? $arr_bookings['rider_to_driver_request_details']['vehicle_details']['vehicle_type_details']['vehicle_type'] :"";

            $driver_fair_charge = isset($arr_bookings['driver_fair_charge']) ? $arr_bookings['driver_fair_charge']:0.00;

            $distance           = isset($arr_bookings['distance']) ? $arr_bookings['distance']:0;

            $admin_commission   = isset($arr_bookings['admin_commission']) ? $arr_bookings['admin_commission']:0.00;

            $total_amount       = isset($arr_bookings['total_amount']) ? $arr_bookings['total_amount']:0.00;
             
            $final_amount       = isset($arr_bookings['final_amount']) ? $arr_bookings['final_amount']:0.00;

            $promo_code         = isset($arr_bookings['promo_code']) ? $arr_bookings['promo_code']:"";

            $coordinates        = isset($arr_bookings['ride_coordinates_details']['coordinates']) ? $arr_bookings['ride_coordinates_details']['coordinates']:"";
            // dd(json_decode($coordinates));
                  ...
                  <br>
                    <table class="table table-bordered">
                      <tbody>
                            ...
                            <tr>
                              <th style="width: 30%">Driver Fair Charge
                              </th>
                              <td>
                                {{$driver_fair_charge or ''}}
                              </td>
                            </tr>

                            <tr>
                              <th style="width: 30%">Distance
                              </th>
                              <td>
                                {{$distance or ''}}
                              </td>
                            ...
                            <tr>
                              <th style="width: 30%">Admin Commission
                              </th>
                              <td>
                                {{$admin_commission or ''}}
                              </td>
                            ...
                            <tr>
                              <th style="width: 30%">Total Amount
                              </th>
                              <td>
                                {{$total_amount or ''}}
                              </td>
                            ...
                            <tr>
                              <th style="width: 30%">Final Amount
                              </th>
                              <td>
                                {{$final_amount or ''}}
                              </td>
                            ...
                            <tr>
                              <th style="width: 30%">Ride Coordinates
                              </th>
                              <td>
                                {{$coordinates or ''}}
                              </td>
