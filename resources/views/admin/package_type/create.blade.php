           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="package_type" maxlength="40" placeholder="Enter Package Type" data-rule-required="true" value="{{ old('package_type') }}"  />
             ...
             <div class="form-group" style="">
              ...
              <div class="col-sm-5 col-lg-2 controls" >
                    <input type="radio" name="is_special_type" id="yes_is_special_type" value="1"/> YES
                <label for="filled-in-box"></label>
              </div>
              <div class="col-sm-5 col-lg-2 controls" >
                    <input type="radio" name="is_special_type" checked="" id="no_is_special_type" value="0"/> NO
                <label for="filled-in-box"></label>
              </div> 
