				...
				<table class="table table-advance"  id="table_module" >
					...
					<tbody>
						...
						<tr>
							...
							<td> 
								<a href="{{ $module_url_path.'/edit/'.base64_encode($email_template['id']) }}"  title="Edit" class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip btn-delets">
