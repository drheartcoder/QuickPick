   ...
   <div class="box {{ $theme_color }}">
      ...
      <div class="box-content">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-9 col-lg-4 controls">
               {!! Form::text('phone',$arr_data['contact_number'],['class'=>'form-control', 'data-rule-required'=>'true','data-rule-number'=>'true','data-rule-maxlength'=>'16','data-rule-minlength'=>'7','placeholder'=>'Contact Number']) !!}
