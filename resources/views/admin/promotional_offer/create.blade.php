           ...
           {!! Form::open([ 'url' => $module_url_path.'/store',
            ...
            <div class="form-group">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="banner_title" id="banner_title" placeholder="Enter Banner Title" data-rule-required="true"  value="" id="banner_title"/>
              ...
              <div class="col-sm-9 col-lg-10 controls">
                 <div class="fileupload fileupload-new" data-provides="fileupload">
                    <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                        <img src="{{url('/').'/uploads/default-load-image.jpg' }}">
                    </div>
                    ...
                    <div>
                       ...
                       <input type="file"  data-validation-allowing="jpg, png, gif" class="file-input news-image validate-image" name="banner_image" id="image" required=""/>
                       </span>
