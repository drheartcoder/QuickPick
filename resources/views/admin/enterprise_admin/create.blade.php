          ...
          @include('admin.layout._operation_status')  
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="">
                  <label class="col-sm-3 col-lg-2 control-label">Enterprise Name<i style="color: red;">*</i></label>
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="enterprise_name" placeholder="Enter Enterprise Name" data-rule-required="true" maxlength="100" value="{{ old('company_name') }}" />
                      <span class="help-block">{{ $errors->first('company_name') }}</span>
                  </div>
            </div>

            <div class="form-group" style="">
                  <label class="col-sm-3 col-lg-2 control-label">Email-Id<i style="color: red;">*</i></label>
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="email" placeholder="Enter Email Id" data-rule-required="true" data-rule-email="true" value="{{ old('email') }}" />
                      <span class="help-block">{{ $errors->first('email') }}</span>
                  </div>
            </div>
            
            {{-- <div class="form-group" style="">
                  <label class="col-sm-3 col-lg-2 control-label">Number Of Drivers</label>
                  <div class="col-sm-9 col-lg-4 controls" >
                      
                      <input type="text" class="form-control" name="driver_count" placeholder="Enter Number of Driver" data-rule-digits="true" maxlength="10" minlength="1" onkeypress="return isNumberKey(event)" value="{{ old('driver_count') }}" />
                      <div class="help-block">{{ $errors->first('driver_count') }}</div>
                  </div>
            </div> --}}
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-3 controls" >
                      ...
                      <input type="text" class="form-control" name="mobile_no" placeholder="Enter mobile No." data-rule-required="true" onkeypress="return isNumberKey(event)" value="{{ old('mobile_no') }}"  data-rule-digits="true" maxlength="15" minlength="10" />
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="password" class="form-control" name="password" id="password" placeholder="Enter Password" data-rule-pattern="(^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&]{8,})" data-msg-pattern="Min. length should be 8 containing uppercase letter, lowercase letter, number and special character." data-rule-required="true" />
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="password" class="form-control" name="confirm_password" placeholder="Enter Confirm Password" data-rule-required="true" data-rule-equalto="#password"  minlength="8" />
            ...
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Enterprise License</label>
                <div class="col-sm-9 col-lg-10 controls">
                   <input type="file" name="enterprise_license" id="enterprise_license" data-rule-required="true"/>
                    <span class='help-block'>{{ $errors->first('enterprise_license') }}</span>  
