      ...
      <div class="col-md-12">
           ...
           {!! Form::hidden('user_id',isset($arr_data['id']) ? $arr_data['id']: "")!!}
                 ...
                 <div class="fileupload fileupload-new" data-provides="fileupload">
                   <div class="fileupload-new img-thumbnail" style="width: 200px; height: 150px;">
                    ...
                    <div>
                       ...
                       {!! Form::file('profile_image',['id'=>'profile_image','class'=>'file-input validate-image','data-rule-required'=>'']) !!}
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      ...
                      {!! Form::text('enterprise_name',isset($arr_data['company_name']) ? $arr_data['company_name']: "",['class'=>'form-control','data-rule-required'=>'true', 'placeholder'=>'Enter Enterprise Name' , 'maxlength'=>"100"]) !!}  
          ...
          <div class="form-group" style="">
                ...
                <div class="col-sm-9 col-lg-3 controls" >
                    {!! Form::text('text',isset($arr_data['mobile_no']) ? $arr_data['mobile_no']: "",['class'=>'form-control', 'placeholder'=>'Enter Mobile No','name'=>'mobile_no', 'maxlength'=>"15" ,'minlength'=>"6" ]) !!}  
          ...
          <div class="form-group">
              ...
              <div class="col-sm-9 col-lg-10 controls">
                 <input type="file" name="enterprise_license" id="enterprise_license"/>
                  <span>{{isset($arr_data['enterprise_license']) ? $arr_data['enterprise_license'] : ''}}</span>
