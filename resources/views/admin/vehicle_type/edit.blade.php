           ...
           {{ csrf_field() }}
            ...
            <div class="row">                         
                <h3 style="margin-left: 20px !important;">Vehicle Dimensions:
                    <a data-trigger="hover" data-placement="top" data-content="Where can I get this?" data-toggle="modal" data-target="#vehicle_image" class="show-popover popup-details"> <i style="color: #fff;" class="fa fa-question"></i> </a>
                </h3>
            </div>
                    ...
                    <div class="col-lg-6">
                      ...
                      <div class="form-group" >
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <input type="text" class="form-control" name="vehicle_type" id="vehicle_type" placeholder="Enter vehicle type"  value="{{ isset($arr_data['vehicle_type']) ? $arr_data['vehicle_type'] :'' }}" />
                                </div>  
                      ...
                      <div class="form-group" >
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <input type="text" class="form-control" name="starting_price" id="starting_price" placeholder="Enter Starting price"  value="{{ isset($arr_data['starting_price']) ? $arr_data['starting_price'] :'' }}" />
                                </div>  
                      ...
                      <div class="form-group" >
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <input type="text" class="form-control" name="per_miles_price" id="per_miles_price" placeholder="Enter Per Miles price"  value="{{ isset($arr_data['per_miles_price']) ? $arr_data['per_miles_price'] :'' }}" />
                                </div>  
                      ...
                      <div class="form-group" >
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <input type="text" class="form-control" name="per_minute_price" id="per_minute_price" placeholder="Enter Per Minute Price"  value="{{ isset($arr_data['per_minute_price']) ? $arr_data['per_minute_price'] :'' }}" />
                                </div>  
                      ...
                      <div class="form-group" >
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <input type="text" class="form-control" name="minimum_price" id="minimum_price" placeholder="Enter Minimum price"  value="{{ isset($arr_data['minimum_price']) ? $arr_data['minimum_price'] :'' }}" />
                                </div>  
                      ...
                      <div class="form-group" >
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <input type="text" class="form-control" name="cancellation_base_price" id="cancellation_base_price" placeholder="Enter Cancellation price"  value="{{ isset($arr_data['cancellation_base_price']) ? $arr_data['cancellation_base_price'] :'' }}" />
                                </div>  
                      ...
                      <div class="form-group" >
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <input type="text" class="form-control" name="no_of_pallet" id="no_of_pallet" placeholder="Enter No of Pallet" value="{{ isset($arr_data['no_of_pallet']) ? $arr_data['no_of_pallet'] :'' }}" />
                                </div>  
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <select class="form-control" name="is_usdot_required" id="is_usdot_required">
                                     ...
                                     <option  @if(isset($arr_data['is_usdot_required']) && $arr_data['is_usdot_required'] == '1') selected="" @endif value="1">Yes</option>     
                                     <option  @if(isset($arr_data['is_usdot_required']) && $arr_data['is_usdot_required'] == '0') selected="" @endif value="0">No</option>     
                                  </select>
                            ...
                            <div class="col-sm-9 col-lg-7 controls" >
                                <div class="form-group">
                                  <select class="form-control" name="is_mcdoc_required" id="is_mcdoc_required">
                                     <option value="">Select</option>     
                                     <option  @if(isset($arr_data['is_mcdoc_required']) && $arr_data['is_mcdoc_required'] == '1') selected="" @endif value="1">Yes</option>     
                                     <option  @if(isset($arr_data['is_mcdoc_required']) && $arr_data['is_mcdoc_required'] == '0') selected="" @endif value="0">No</option>     
                                  </select>
                  ...
                  <div class="row">                  
                    <div class="col-lg-6">
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_min_length" id="vehicle_min_length" onblur="total_volume()" placeholder="Enter minimum length" value="{{ isset($arr_data['vehicle_min_length']) ? $arr_data['vehicle_min_length'] :'0' }}" />
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_min_height" id="vehicle_min_height" onblur="total_volume()" placeholder="Enter minimum height" value="{{ isset($arr_data['vehicle_min_height']) ? $arr_data['vehicle_min_height'] :'0' }}" />
                                  <span class="input-group-addon">ft</span>
                                </div>  
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_min_breadth" id="vehicle_min_breadth" onblur="total_volume()" placeholder="Enter minimum breadth" value="{{ isset($arr_data['vehicle_min_breadth']) ? $arr_data['vehicle_min_breadth'] :'0' }}" />
                                  <span class="input-group-addon">ft</span>
                                </div>  
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_min_volume" readonly="" id="vehicle_min_volume" value="{{ isset($arr_data['vehicle_min_volume']) ? number_format($arr_data['vehicle_min_volume'],2) :'0' }}" />
                                  <span class="input-group-addon">ft<sup>3</sup></span>
                                </div>  
                                  <span class="help-block">{{ $errors->first('vehicle_min_volume') }}</span>
                              </div>
                        </div> 
                         <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_min_weight" id="vehicle_min_weight" placeholder="Enter minimum weight capacity" value="{{ isset($arr_data['vehicle_min_weight']) ? number_format($arr_data['vehicle_min_weight'],2) :'0' }}" />
                    ...
                    <div class="col-lg-6">
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_max_length" id="vehicle_max_length" onblur="total_volume()" placeholder="Enter maximum length" value="{{ isset($arr_data['vehicle_max_length']) ? $arr_data['vehicle_max_length'] :'0' }}" />
                                  <span class="input-group-addon">ft</span>
                                </div>  
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_max_height" id="vehicle_max_height" onblur="total_volume()" placeholder="Enter maximum height" value="{{ isset($arr_data['vehicle_max_height']) ? $arr_data['vehicle_max_height'] :'0' }}" />
                                  <span class="input-group-addon">ft</span>
                                </div>  
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_max_breadth" id="vehicle_max_breadth" onblur="total_volume()" placeholder="Enter maximum breadth" value="{{ isset($arr_data['vehicle_max_breadth']) ? $arr_data['vehicle_max_breadth'] :'0' }}" />
                                  <span class="input-group-addon">ft</span>
                                </div>  
                        ...
                        <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_max_volume" readonly="" id="vehicle_max_volume" placeholder="Enter vehicle maximum volume" value="{{ isset($arr_data['vehicle_max_volume']) ? number_format($arr_data['vehicle_max_volume'],2) :'0' }}" />
                                  <span class="input-group-addon">ft<sup>3</sup></span>
                                </div>  
                         ...
                         <div class="form-group">
                              ...
                              <div class="col-sm-9 col-lg-7 controls" >
                                <div class="input-group">
                                  <input type="text" class="form-control" name="vehicle_max_weight" id="vehicle_max_weight" placeholder="Enter maximum weight capacity" value="{{ isset($arr_data['vehicle_max_weight']) ? $arr_data['vehicle_max_weight'] :'0' }}" />
                                  <span class="input-group-addon">lb</span>
                                </div>  
                ...
                <div class="col-md-12" style="margin-top: 15px">    
                  <div class="form-group">
                    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
                      ...
                      {!! Form::submit('Update',['class'=>'btn btn btn-primary','id'=>'edit_vehicle_type','value'=>'true'])!!}
                      &nbsp;
...
<div id="vehicle_image" class="modal fade" role="dialog">
  ...
  <script>
      ...
      $('#edit_vehicle_type').on('click',function(){
