          ...
          @include('admin.layout._operation_status')  
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="vehicle_number" placeholder="Enter Vehicle License Plate Number" data-rule-required="true" value="{{ isset($arr_data['vehicle_number']) ? $arr_data['vehicle_number'] :'' }}" />
