           ...
           {!! Form::hidden('user_id',isset($arr_data['id']) ? $arr_data['id']: "")!!}
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      ...
                      {!! Form::text('company_name',isset($arr_data['company_name']) ? $arr_data['company_name']: "",['class'=>'form-control','data-rule-required'=>'true', 'placeholder'=>'Enter Company Name' , 'maxlength'=>"100"]) !!}  
