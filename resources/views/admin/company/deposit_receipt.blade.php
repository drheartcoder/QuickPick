	...
	<div class="col-md-12">
		<div class="box {{ $theme_color }}">
			...
			<div class="box-content">
				...
				<?php  
					$company_name = isset($arr_company['company_name']) ? $arr_company['company_name'] : '';
				?>
					...
					<div class="btn-toolbar pull-right clearfix">
						<div class="btn-group"> 
							<a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip refrash-btns" 
								title="Refresh" 
								href="{{ $module_url_path.'/deposit_receipt/'.$company_id }}"
				...
				<div class="col-md-12">
							<div class="driver-inline">
		                     ...
		                     <div class="titles-h1">
		                        ...
		                        <p><strong>Company/Driver Total Earning</strong></p>
		                     </div>
		                    ...
		                    <div class="driver-inline">
		                      ...
		                      <div class="titles-h1">
		                        ...
		                        <p><strong>Company/Driver Paid Amount</strong></p>
		                      </div>
		                      <div class="clearfix"></div>
		                    </div>
		                    ...
		                    <div class="driver-inline">
		                      ...
		                      <div class="titles-h1">
		                        ...
		                        <p><strong>Company/Driver Unpaid Amount</strong></p>
		                      </div>
		                      <div class="clearfix"></div>
		                    </div>
				...
				<div class="col-md-12" >
					...
					<input type="hidden" name="company_id" id="company_id" value="{{isset($company_id) ? $company_id :'0'}}">
