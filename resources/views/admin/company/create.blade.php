           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="company_name" placeholder="Enter Company Name" data-rule-required="true" maxlength="100" value="{{ old('company_name') }}" />
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-3 controls" >
                      ...
                      <input type="text" class="form-control" name="mobile_no" placeholder="Enter mobile No."{{--  data-rule-pattern="\+[1-9]{1,3}[0-9]{9,15}" --}} data-rule-required="true" onkeypress="return isNumberKey(event)" value="{{ old('mobile_no') }}"  data-rule-digits="true" maxlength="15" minlength="10" />
            ...
            <div class="form-group">
                <label class="col-sm-3 col-lg-2 control-label">Company License</label>
                <div class="col-sm-9 col-lg-10 controls">
                   <input type="file" name="driving_license" id="driving_license" data-rule-required="true"/>
