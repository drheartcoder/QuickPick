        ...
        <div class="box-content">
          ...
          <div class="table-responsive" style="border:0">     
              ...
              <tr>
                ...
                <td>
                  @if(isset($value['validity_from']) && !empty($value['validity_from']))
                     <?php
                          $date = date_create($value['validity_from']);
                ...
                <td>
                  @if(isset($value['validity_to']) && !empty($value['validity_to']))
                     <?php
                          $date = date_create($value['validity_to']);
                          $date = date_format($date,'d M Y');
                      ?>
                  @else
                    <?php $date=''; ?>      
                ...
                <td>
                  {{ isset($value['promo_code_usage_limit']) ? $value['promo_code_usage_limit'] : '' }}
                </td>
                ...
                <td>
                     ...
                     @if($value['validity_to']<date("Y-m-d"))
                      <a class="btn btn-circle btn-to-success btn-bordered btn-fill show-tooltip call_loader" href="{{ $module_url_path.'/edit/'.base64_encode($value['id'])}}" title="" data-original-title="Edit">
