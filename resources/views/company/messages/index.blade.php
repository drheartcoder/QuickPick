                    ...
                    <div class="chat-messagess">
                       <div class="clearfix"></div>
                        <ul class="content-txt1 content-d" id="driver-list">
                            ...
                            @if(isset($arr_chat_list) && sizeof($arr_chat_list)>0)
                                @foreach($arr_chat_list as $key => $value)
                                    ...
                                    <li 
                                        ...
                                        <div class="avatar-outr"> 
                                            <div class="avatar-img"><img src="{{ isset($value['profile_image']) ? $value['profile_image'] : url('/uploads/default-profile.png') }}" alt="" /></div>
                                        </div>
                                        ...
                                        <div class="clearfix"></div>
                                        @if(isset($value['unread_message_count']) && $value['unread_message_count']>0)
                                            <span class="chat-coun">{{ $value['unread_message_count'] }}</span>
                                        @endif
                                    </li>
                                @endforeach
                            @else
...
<script type="text/javascript">
    ...
    function startCurrentChat(ref) {
        ...
        if(module_url_path!=undefined && user_id!=undefined && user_id!=''){
            var url = module_url_path+'?user_id='+user_id;
            window.location.href = url;
        }
    }
