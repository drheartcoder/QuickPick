           ...
           <div class="form-group">
            ...
            <div class="form-group" style="margin-top: 25px;">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="first_name" placeholder="Enter First Name" data-rule-required="true" maxlength="40" value="{{ old('first_name') }}" />
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="last_name" placeholder="Enter Last Name" data-rule-required="true" maxlength="40" value="{{ old('last_name') }}" />
             ...
             <div class="geo-details">
              ...
              <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-3 controls" >
                      <input type="text" class="form-control" name="mobile_no" placeholder="Enter Mobile Number." data-rule-required="true" data-rule-digits="true" onkeypress="return isNumberKey(event)" {{-- data-rule-pattern="\+[1-9]{1,3}[0-9]{9,15}" --}} maxlength="16" minlength="7" value="{{ old('mobile_no') }}" />
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="password" class="form-control" name="password" id="password" data-rule-pattern="(^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[$@$!%*?&])[A-Za-z\d$@$!%*?&]{8,})" data-msg-pattern="Min. length should be 8 containing uppercase letter, lowercase letter, number and special character." placeholder="Enter Password" data-rule-required="true" value="{{ old('password') }}" minlength="6" />
