          ...
          @include('company.layout._operation_status')  
           ...
           {{ csrf_field() }}
            ...
            <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      <input type="text" class="form-control" name="vehicle_number" placeholder="Enter Vehicle License Plate Number" data-rule-required="true" maxlength="15" minlength="2"  value="{{ old('vehicle_number') }}" />
             ...
             <div class="form-group" >
                ...
                <div class="col-sm-9 col-lg-4 controls" >
                    <select class="form-control" id="driver_name" name="driver_id">
                      ...
                      @if(isset($arr_driver_details) && count($arr_driver_details)>0)
                        @foreach($arr_driver_details as $key => $value)
