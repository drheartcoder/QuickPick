			...
			<div class="box {{ $theme_color }}">
             ...
             <div class="col-sm-5 col-lg-3">
              ...
              <input type="hidden" name="q_date" id="q_date">
				...
				@if(isset($arr_normal_services) && !empty($arr_normal_services))  
		            <div class="form-group pull-right" style="margin-top: 25px; margin-right: 35px !important;  vertical-align: middle;" >
			            <div class="row">
			            	<div class="col-md-5">
				            ...
				            <div class="col-md-7">
				            	<div class="controls" >
				                  <select class="form-control vehicle_details"  name="vehicle_type" id="vehicle_type" onchange="get_vehicle_data();">
				                      <option value="all">All</option>
				                    @foreach($arr_normal_services as $value)
				                      <option value="{{$value['id']}}">{{$value['vehicle_type']}}</option>
				                    @endforeach
				                  </select>      
				              </div>
				            </div>
    ...
    <script type="text/javascript">
      ...
      $(document).ready(function()
      {
        table_module = $('#table_module').DataTable({
          ...
          bFilter: false,
          ajax: {
          'url':'{{ $module_url_path.'/get_booking_records'}}',
          'data': function(d)
            {
...
$(".vehicle_details").change(function(){
 ...
 function generateExcel()
 {
    ...
    var url = "{{url('/company/report').'/generate_excel?from_date='}}"+from_date+"&to_date="+to_date+"&vehicle_type="+vehicle_type;
