user_module_title    @extends('company.layout.master')                
    ...
    <div id="breadcrumbs">
        <ul class="breadcrumb">
            ...
            <li class="active">{{ isset($user_module_title)?$user_module_title:"" }}</li>
        </ul>
      </div>
    <!-- END Breadcrumb -->
    <!-- BEGIN Main Content -->
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="box-content">
          ...
          <a class="btn btn-circle btn-to-success print" onclick="generate_user_excel()" >Print</a>
          </div>
            </div><br>     
    ...
    function change_default_type()
    {
      ...
      { 
        ...
        table_module = $('#table_module').DataTable({
          ...
          bFilter: false,
          ajax: {
          'url':'{{ $module_url_path.'/get_user_records?role='}}{{$role or ''}}',
          'data': function(d)
            {
...
<script type="text/javascript">
 ...
 function filterData()
  ...
  function generate_user_excel()
  {
    var from_date = $("#from_date").val(); 
    var to_date   = $("#to_date").val();
    var report_type = $("#user_type").val();
    var url = "{{$module_url_path.'/generate_user_excel?from_date='}}"+from_date+"&to_date="+to_date+"&report_type="+report_type;
