        ...
        <div class="col-md-12">
            <div class="box {{ $theme_color }}">
                ...
                <div class="box-content">
                    ...
                    {!! Form::open([ 'url' => $company_panel_slug.'/update_password',
                                 'method'=>'POST',
                                 'id'=>'validation-form',
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9 col-lg-4 controls">
                                ...
                                {!! Form::password('new_password',['class'=>'form-control',
                                        ...
                                        'data-msg-pattern'=>'Min. length should be 8 containing uppercase letter, lowercase letter, number and special character.',
                                        'id'=>'new_password',
