...
<html>
    <head>
     ...
     <body class="login-page" style='background-image: url("{{url('/')}}/images/admin/2.jpg") !important;background-repeat:repeat-x;background-size: 100%;' id="background">
        ...
        <div class="login-wrapper">
            ...
            {!! Form::open([ 'url' => $company_panel_slug.'/process_login',
                                 'method'=>'POST',
                                 'id'=>'form-login' 
                                ]) !!} 
                ...
                <div class="form-group ">
                    <div class="controls">
                        <input type="text" class="form-control" name="email" placeholder="Enter Email" data-rule-required="true" data-rule-email="true"  />
            ...
            <form id="form-forgot" action="{{ url($company_panel_slug.'/process_forgot_password') }}" method="post" style="display:none">
                 {{ csrf_field() }}
