...
<div class="col-md-12">
   <div class="box {{ $theme_color }}">
      ...
      <div class="box-content">
         ...
         <div class="form-group">
            <label class="col-sm-3 col-lg-2 control-label">Company Name
            <i class="red">*
            </i>
            </label>
            <div class="col-sm-9 col-lg-4 controls">
               {!! Form::text('company_name',$arr_data['company_name'],['class'=>'form-control','data-rule-required'=>'true','data-rule-maxlength'=>'255', 'placeholder'=>'Company Name']) !!}
               <span class='help-block'>{{ $errors->first('company_name') }}
               </span>
            </div>
         </div>
         {{-- <div class="form-group">
         ...
         <div class="form-group">
            ...
            <div class="col-sm-9 col-lg-4 controls">
               {!! Form::text('email',$arr_data['email'],['class'=>'form-control', 'data-rule-required'=>'true','readonly','data-rule-email'=>'true','data-rule-maxlength'=>'255','placeholder'=>'Email']) !!}
         ...
         <div class="form-group" style="">
                  ...
                  <div class="col-sm-9 col-lg-4 controls" >
                      {!! Form::text('address',isset($arr_data['address']) ? $arr_data['address']: "",['class'=>'form-control','data-rule-required'=>'true', 'placeholder'=>'Enter Address', 'id'=>"address_user", 'rows'=>'4','cols'=>'50']) !!}
       ...
       {{--   <div class="form-group">
         ...
         <div class="form-group">
            <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2">
               ...
               <a href="{{ url($company_panel_slug.'/dashboard') }}" class="btn">Back</a> 
            </div>
         </div>
         {!! Form::close() !!}
      </div>
