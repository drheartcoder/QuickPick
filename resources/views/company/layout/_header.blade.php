...
<html>
    ...
    <?php
            ...
            $stripe_account_id = isset($arr_login_user_details['stripe_account_id']) ? $arr_login_user_details['stripe_account_id'] : '';

            Session::forget('stripe_account_id_not_set');
            if($stripe_account_id == ''){
                Session::put('stripe_account_id_not_set','Please complete stripe account verification process.');
            }
            ...
            <ul class="nav flaty-nav pull-right">
                ...
                <li class="user-profile">
                    ...
                    <?php 
                        ...
                        $profile_img = isset($arr_login_user_details['profile_image'])  ? $arr_login_user_details['profile_image'] : "";
                    ?>                

                    <img class="nav-user-photo" src="{{ $profile_img }}" alt="">
                        <span class="hhh" id="user_info">
                          Welcome {{$arr_login_user_details['full_name'] or ''}}
                        </span>
