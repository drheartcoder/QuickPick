...
<script type="text/javascript">
    ...
    var LAT_LNG_FILE = BASE_URL+'/lat-lng.json';
    ...
    function track_live_trip() {
        ...
        if(ARR_LAT_LNG.length>0)
        {
            if(current_marker_index == (ARR_LAT_LNG.length - 1 ))
            {
                return;
            }
            var obj_data = ARR_LAT_LNG[current_marker_index];
            ...
            if(obj_data!=undefined){
                ...
                if(marker!=undefined && marker!=''){
                    if (marker.driver_id != undefined) {
                        ...
                        var curr_lat = parseFloat(obj_data.lat);
                        var curr_lng = parseFloat(obj_data.lng);
                        ...
                        var myLatlng = new google.maps.LatLng(obj_data.lat,obj_data.lng);
                        ...
                        $('#markerLayer img').parent().last().addClass('sedan-new-class');
                        ...
                        // $('#markerLayer img').parent().last().css({
