                    ...
                    <div class="row">
                        ...
                        @include('front.layout._operation_status')
                            <div class="edit-posted-bg-main">
                                ...
                                {{-- {{ dump(file_exists($user_profile_base_img_path.$arr_data['profile_image'])) }} --}}
                               ...
                               @else
                                ...
                                <form name="frm-edit-profile" method="post" action="{{url( config('app.project.role_slug.user_role_slug'))}}/update_profile" data-parsley-validate enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        {{-- <div class="col-sm-12 col-md-12 col-lg-12">
                                            <div class="form-group">
                                                <input type="text" name="mobile_no" data-parsley-required-message="Please enter mobile no" data-parsley-required="true" data-parsley-errors-container="#err_mobile_no" value="{{ $arr_data['mobile_no'] or ''}}">
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
            ...
            <div class="form-group marg-top">
                <input type="text" id="mobile_no" value="mobile_no" placeholder="Enter mobile number">
