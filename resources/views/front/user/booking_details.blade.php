                ...
                @include('front.layout._operation_status')
                                ...
                                <div class="row">
                                    <div class="col-sm-10 col-md-10 col-lg-10">
                                        ...
                                        <div class="review-content-block">
                                            <div class="review-send-head minus-top">
                    ...
                    <div class="edit-posted-bg-main my-job-details bord-none">
                         <div class="row">
                            ...
                            <div class="col-sm-12 col-md-6 col-lg-6">
                              <div class="receipt-main-block">
                               ...
                               @if(isset($arr_trip_details['booking_status']) && $arr_trip_details['booking_status'] != 'CANCEL_BY_USER')
                        ...
                        @if((isset($arr_trip_details['booking_status']) && $arr_trip_details['booking_status'] == 'COMPLETED') &&
                            ...
                            <a href="{{url('/').'/'.$user_path.'/download_invoice?booking_id='.base64_encode($arr_trip_details['booking_id'])}}"><button type="button" class="white-btn chan-left"><i class="fa fa-download"></i> Invoice</button></a>

                        @endif

                        @if(isset($arr_trip_details['booking_status']) && $arr_trip_details['booking_status'] == 'COMPLETED')
                           <a href="{{ url('/').'/'.$user_path.'/my_booking?trip_type=COMPLETED'}}"><button type="button" class="white-btn chan-left">Back</button></a>
                        @elseif(isset($arr_trip_details['booking_status']) && ($arr_trip_details['booking_status'] == 'CANCEL_BY_USER' || $arr_trip_details['booking_status'] == 'CANCEL_BY_DRIVER' || $arr_trip_details['booking_status'] == 'CANCEL_BY_ADMIN'))
