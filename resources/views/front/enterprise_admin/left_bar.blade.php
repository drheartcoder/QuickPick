<?php 
    $user_path     = config('app.project.role_slug.enterprise_admin_role_slug'); 
...
<div class="col-sm-3 col-md-2 col-lg-2">
  <div class="left-bar">
    <ul>
      ...
      <li class="<?php  if(Request::segment(2) == 'manage_users' || Request::segment(2) == 'add_users' || Request::segment(2) == 'edit_user'){ echo 'active'; } ?>">
        <a href="{{ url('/').'/'.$user_path.'/manage_users'}}">
              <span class="dash-img pro-my-img"></span>
              <span class="dash-title">Enterprise Users</span>
              <div class="clearfix"></div></a>
      </li>
