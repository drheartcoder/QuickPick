...
<div class="fare-estimate-map-wrapper">
    ...
    <div class="fare-estimate-map-direction-block">
        ...
        <div class="fare-estimate-map-direction top">
             <div class="form-group on-map">
                    <input type="text" id="pickup_location" name="pickup_location" class="input-box" placeholder="Enter Pickup Location" data-parsley-required-message="Please enter pickup location" data-parsley-required="true" data-parsley-errors-container="#err_pickup_location" />
                    <div id="err_pickup_location" class="error"></div>
                    <div class="map-direction-circle"></div>
             </div>
             <div class="form-group on-map">
                    <input type="text" id="drop_location" name="drop_location" class="input-box" placeholder="Enter Destination" data-parsley-required-message="Please enter drop location" data-parsley-required="true" data-parsley-errors-container="#err_drop_location"/>
        ...
        <div class="fare-estimate-map-direction" id="div_packaging_details" >
            
            <div class="row">
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                        <select name="package_type" id="package_type" data-parsley-required-message="Please select package type" data-parsley-required="true" data-parsley-errors-container="#err_package_type"> 
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group">
                    <input type="text" class="input-box" id="weight" name="package_weight" placeholder="Weight (Pounds)" data-parsley-required-message="Please enter weight in pound" data-parsley-required="true" data-parsley-errors-container="#err_weight"/>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                    <input type="text" class="input-box" id="length" name="package_length" placeholder="Length (ft)" data-parsley-required-message="Please enter Length in ft" data-parsley-required="true" data-parsley-errors-container="#err_length" />
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                    <input type="text" class="input-box" id="width" name="package_breadth" placeholder="Width (ft)" data-parsley-required-message="Please enter width in ft" data-parsley-required="true" data-parsley-errors-container="#err_width" />
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                    <input type="text" class="input-box" id="height" name="package_height" placeholder="Height (ft)" data-parsley-required-message="Please enter height in ft" data-parsley-required="true" data-parsley-errors-container="#err_height" />
                ...
                <div class="col-sm-6 col-md-6 col-lg-6">
                    <div class="form-group">
                    <input type="text" class="input-box" id="quantity" name="package_quantity" placeholder="Quantity" data-parsley-required-message="Please enter quantity" data-parsley-required="true" data-parsley-errors-container="#err_quantity" />
        ...
        <div class="fare-estimate-map-direction price" id="div_fare_estimate" style="display: none">
