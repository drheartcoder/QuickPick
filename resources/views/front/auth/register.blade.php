                ...
                <div class="login-section login2 change">
                    ...
                    <div class="login-tabs">
                        ...
                        <div class="login-form-block">
                            <form name="frm-login" id="frm_login" method="post" autocomplete="off" action="{{url('/process_register')}}" data-parsley-validate>
                            ...
                            <div id="div_part_one">
                                ...
                                <div class="form-group login">
                                    <input type="text" class="input-box" placeholder="First Name" name="first_name" id="first_name" data-parsley-required-message="Please enter first name" data-parsley-required="true" data-parsley-errors-container="#err_first_name" value="{{ isset($arr_prev_data['first_name']) ? $arr_prev_data['first_name'] : '' }}" />
                                    <span class="bar"></span>
                                    <div class="error" id="err_first_name"></div>
                                </div>

                                <div class="form-group login">
                                    <input type="text" class="input-box" placeholder="Last Name" name="last_name" id="last_name" data-parsley-required-message="Please enter last name" data-parsley-required="true" data-parsley-errors-container="#err_last_name" value="{{ isset($arr_prev_data['last_name']) ? $arr_prev_data['last_name'] : '' }}"/>
                                    <span class="bar"></span>
                                    <div class="error" id="err_last_name"></div>
                                </div>

                                <div class="form-group login">
                                    <input type="text" class="input-box" placeholder="Email Address" name="email" id="email" data-parsley-required-message="Please enter email address" data-parsley-required="true" data-parsley-errors-container="#err_email" value="{{ isset($arr_prev_data['email']) ? $arr_prev_data['email'] : '' }}"/>
                                    <span class="bar"></span>
                                ...
                                <div class="form-group login">
                                    <div class="form-group date">
                                        ...
                                        <input class="input-box" id="datepicker" type="text" name="dob" placeholder="Date of birth" data-parsley-required-message="Please enter date of birth" data-parsley-required="true" data-parsley-errors-container="#err_datepicker">
                                ...
                                <div class="form-group login">
                                    <input type="text" class="input-box" placeholder="Enter Referral code" name="referral_code" id="referral_code" />
                                </div>
                            ...
                            <div id="div_part_two" style="display:none">
                                ...
                                <!-- <div id="message" align="left">
                                  ...
                                  <p id="special_character" class="invalid">A special character</p>
