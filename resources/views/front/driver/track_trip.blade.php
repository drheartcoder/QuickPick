        ...
        <div class="container-fluid">
            <div class="row">
                ...
                @include('front.layout._operation_status')
                    ...
                    @if(isset($arr_trip_details) && count($arr_trip_details)>0)
                        ...
                        <div class="edit-posted-bg-main my-job-details">
                            ...
                            @endif
                               <a href="{{ url('/').'/'.$user_path.'/dashboard'}}"><button type="button" class="white-btn chan-left">Back</button></a>
                            </div>
                        </div>
                    @else
                        <div class="no-record-block">
                         <span>No Ongoing Trip Available</span> 
                       </div>
                    @endif
...
<script type="text/javascript">
    ...
    var booking_id      = '{{isset($arr_trip_details['booking_id']) ? $arr_trip_details['booking_id'] :0}}';
    ...
    var DRIVER_BASE_URL = "{{url('/').'/'.$user_path.'/'}}";
        ...
        $.ajax({
            ...
            success:function(response)
            {
                ...
                if(response.status=="success")
                {
                    ...
                    setTimeout(function(){ 
                        window.location.href = DRIVER_BASE_URL+'my_job?trip_type=CANCELED';
                    }, 3000);
    ...
    function show_on_map_available_driver(obj_available_driver){
        ...
        if(obj_available_driver.booking_status == 'COMPLETED'){
          setTimeout(function(){ 
            window.location.href = DRIVER_BASE_URL+'my_job?trip_type=COMPLETED';
          }, 2000);
        }
