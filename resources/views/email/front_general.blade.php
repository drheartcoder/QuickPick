               ...
               <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                     <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                              <td><a href="{{url('/')}}" style="text-decoration: none;"><h1 style="color: #5a97e1;">{{config('app.project.name')}}</h1>
                                 <!-- <img src="{{url('/')}}/images/front/inner-logo.png"  alt="logo" width="50%" height="" /> -->
                                 </a></td>
                  ...
                  <tr>
                     <td style="text-align:center; color:#fff;background-color:#2a2a2a; padding-bottom:10px;"> Copyright {{ date("Y") }} by <a href="{{url('/')}}" style="text-align:center; color:#fff;">{{ config('app.project.name') }}</a> All Right Reserved.
