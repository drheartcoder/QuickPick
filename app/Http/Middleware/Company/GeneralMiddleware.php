...
class GeneralMiddleware
{
    ...
    public function handle($request, Closure $next)
    {
        ...
        view()->share('company_panel_slug',config('app.project.company_panel_slug'));
    ...
    public function login_user_details()
    {
        ...
        $arr_login_user_details['stripe_account_id'] = '';
        ...
        {   
            ...
            $arr_login_user_details['stripe_account_id'] = isset($user->stripe_account_id) ? $user->stripe_account_id :'';
            ...
            {   
                ...
                $arr_login_user_details['full_name']     = $company_name;
            }
