...
class ReportController extends Controller
{
                                ...
                                )
    {
        ...
        $this->rating_module_title          = "Ratings Report";
        $this->user_module_title            = "Users Report";
        $this->driver_module_title          = "Drivers Report";
    	$this->module_view_folder           = "company.report";
    	$this->theme_color                  = theme_color();
    	$this->company_panel_slug           = config('app.project.company_panel_slug');
    	$this->module_url_path              = url(config('app.project.company_panel_slug')."/report");		
    ...
    {     
        ...
        else if(isset($arr_search_column['date_filter']) && $arr_search_column['date_filter']!="")
        { 
   ...
   {        
      ...
      $obj_bookings = $this->UserModel
                   ->whereHas('roles',function($query){
                    ...
                    $obj_bookings = $obj_bookings->where('is_company_driver','=','1')->get();
   ...
   public function generate_excel(Request $request)
   {
      ...
      if($obj_bookings)
      {
        ...
        {  
          ...
          // $tbl_columns['15'] = 'Driver Fare Charge';
          // $tbl_columns['16'] = 'Admin Commission';
          // $tbl_columns['17'] = 'Admin Per Km Charge';
          // $tbl_columns['18'] = 'Driver Per Km Charge';
