...
trait MultiActionTrait
{
    public function multi_action(Request $request)
    {
        ...
        {  
            ...
            {
               $this->perform_approve(base64_decode($record_id));    
               Flash::success($this->module_title.' Approved Successfully');  
            }
            elseif($multi_action=="unapprove")
            {
               $this->perform_unapprove(base64_decode($record_id));    
               Flash::success($this->module_title.' Unapproved Successfully');  
            }
        }
    ...
    public function approve($enc_id = FALSE)
    {
        ...
        {
            Flash::error('Problem Occured While '.$this->module_title.' Approved ');
        }
    ...
    public function unapprove($enc_id = FALSE)
    {
        ...
        {
            Flash::error('Problem Occured While '. $this->module_title .' unapproved ');
        }
    ...
    public function perform_approve($id)
    {
        ...
        if($static_page)
        {
            ...
            return $static_page->update(['account_status'=>'approved']);
        }
    ...
    public function perform_unapprove($id)
    {
        ...
        if($static_page)
        {
            return $static_page->update(['account_status'=>'unapproved']);
        }
